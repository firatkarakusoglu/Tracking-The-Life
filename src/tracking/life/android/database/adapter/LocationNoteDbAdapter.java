...
public class LocationNoteDbAdapter {
    ...
    public Cursor selectAllNotesByMemberIdLocationId(long memberId, long locationListId) {  
    	...
    	String selectWhere = KEY_MEMBER_ID + "=" + memberId + KEY_LOCATION_LIST_ID + "=" + locationListId;
        return database.query(DATABASE_TABLE, selectColumns, selectWhere , null, null, null, null);  
    }
}
