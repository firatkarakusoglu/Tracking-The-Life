...
public class LocationCategoryDbAdapter {
	// Database fields
	public static final String DATABASE_TABLE = "location_category";
	...
	public LocationCategoryDbAdapter(Context context) {
		this.context = context;
	}
	
	public LocationCategoryDbAdapter open() throws SQLException {
	 ...
	 */
	public long insertLocationCategory(long memberId, String categoryTitle) {
